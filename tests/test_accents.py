...
class AccentActualTonesTest(AccentTestCase):
    ...
    def test_ShanTou_ShiQu(self):
        ...
        test_cases = [
            ...
            [['liat8', 'si1'], 1, [2, 33]],
            [['siau2', 'ki6'], 1, [25, 25]],
            [['kuan2', 'ka3', 'lv2', 'nek8', 'thiann3'], 3, [25, 55, 25, 5, 21]],
            ...
            [['tsu2', 'jin5'], 1, [25, 55]],
            [['tshai5', 'iang2', 'lv2'], 2, [22, 25, 52]],
            [['bo5', 'liau2', 'ua2'], 2, [22, 25, 52]],
            [['lv2', 'ia7', 'tua7', 'poh4', 'khui3'], 4, [25, 21, 21, 5, 212]],
